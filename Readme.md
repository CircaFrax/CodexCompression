...
### 🗺️ Roadmap
- [x] v3.3.2 - Single EXE, tri clean, Essentiels repliables, drag & drop partout
- [x] v3.3.3 - Prévisualisation images dans l'explorer + recherche
